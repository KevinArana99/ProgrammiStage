				...
				for(int j = 1;i+j < vocali.length;j++)
				{
					if(vocali[i]==vocali[i+j])
					{
                        ...
                        { 
                          ...
                          if (doppia=false)
                          {
                              System.out.println("c'e una doppia");
                              int k=1;
                              int l;
			...
			{		
					if(consonanti[l] != consonanti[l-1])
					{
						consonanti[k] = consonanti[l];
                          ...
                          {
                              System.out.println("non c'e nessuna doppia");
                            for (int i =0; i< consonanti.length;i++)
                            {
                                if(i==1)
                                {
                      ...
                      if(c==3)
                      {
                          System.out.println("le consonanti sono tre");
                          consonanti=DeleteSpace(consonanti);
                          vett = consonanti;
                      }
                        if(c < 3)
                        {
                            System.out.println("le consonanti sono meno di 3");
                          consonanti=DeleteSpace(consonanti);
