...
public class Utente extends Persona
{
    ...
    public int get_N_accessi()
    {
        return n_accessi;
    }
    public Utente(String cognome, String nome, int gg, int mm, int aaaa, char sesso, String luogoDiNascita,String LuogoDiResidenza,String cfiscale,String password,int n_accessi)
    {
       super(cognome,nome,gg,mm,aaaa,sesso,luogoDiNascita,LuogoDiResidenza);
       this.cfiscale = cfiscale;
       this.password = password;
        this.n_accessi = n_accessi;
    }
    ...
    public void Set(String cognome, String nome, int gg, int mm, int aaaa, char sesso, String luogoDiNascita,String LuogoDiResidenza,String cfiscale,String password,int n_accessi)
    {
        super.Set(cognome, nome, gg, mm, aaaa, sesso, luogoDiNascita, LuogoDiResidenza);
    ...
    {
        System.out.println("------------------------------------------------");
        System.out.println("Nuovo Utente \n"+"codice fiscale : "+cfiscale+"\n"+"password : "+password+"\nMAX_ACCESSI : "+MAX_ACCESSI+"\nn_accessi : "+n_accessi);
        System.out.println("------------------------------------------------");
    }
}
